...
func TestCompareErrors(t *testing.T) {
	tests := []struct {
		...
		{"CompareErrorsBothNil", nil, nil, true},
		{"CompareErrorsFirstNil", nil, ErrInvalidEmpty, false},
		{"CompareErrorsSecondNil", ErrInvalidEmpty, nil, false},
		{"CompareErrorsSame", ErrInvalidEmpty, ErrInvalidEmpty, true},
		{"CompareErrorsDiff", ErrInvalidEmpty, ErrInvalidEmail, false},
